...
function sample_school(gamma, policy)
	dm = LarremoreModel(
		gamma;
...
A <- julia_eval("get_adjacency_matrix(sample_school(.033, DoNothing()))")
...
@everywhere function evaluate_school(gamma, policy)
	school = sample_school(gamma, policy)
	for i in 1:(12*7)
